...
emilyChaoApp.controller('mainController', function($scope) {
	$scope.message = 'UIUC CS 2017, Miss Possible Web Dev, Part of NCWITAiC, Passionate about Gender Equality, LGBTQ Equality in the Workplace, Loves Coding, Thinking Deeply, Writing and Singing at the Top of My Lungs';
});
